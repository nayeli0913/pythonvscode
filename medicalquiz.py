...
def q1():
    ...
    with col2:
        ...
        qs1 = st.radio('What is the main job of your heart?',['Pumping blood','Digesting food','Storing energy','Releasing C02'])
...
def q2():
    ...
    with col2:
        ...
        qs2 = st.radio('What do vaccines help protect you from?',['Skin irritation','Diseases like measles and flu','Cuts and bruises','Infections'])
        if qs2 == 'Diseases like measles and flu':
            st.session_state.score += 1
...
def q3():
    ...
    with col2:
        ...
        qs3 = st.radio('Why is it important to wash your hands?',['To smell nice','To make them smooth','To look clean','To kill germs on them'])
        if qs3 == 'To kill germs on them':
            st.session_state.score += 1
        but1,but2,space = st.columns([1,1,1.5])
        with but1:
...
def q4():
    ...
    with col2:
        ...
        qs3 = st.radio('What should you do if you have a fever?',['Play with your friends','Get some rest','Eat a lot','Stay up late'])
        but1,but2,space = st.columns([1,1,1.5])
        with but1:
...
def q5():
    ...
    with col2:
        ...
        qs3 = st.radio('What does a doctor do?',['Fix cars','Help people stay healthy','Teach math','Sell food'])
        but1,but2,space = st.columns([1,1,1.5])
        with but1:
...
def q6():
    ...
    with col2:
        ...
        qs3 = st.radio('What is a healthy snack?',['Candy','Soda','Chips','Fruits'])
        but1,but2,space = st.columns([1,1,1.5])
        with but1:
...
def q7():
    ...
    with col2:
        ...
        qs3 = st.radio('What does it mean to be allergic to something?',['You like it a lot','You cant eat it','Your body reacts to it','You dont like it'])
        but1,but2,space = st.columns([1,1,1.5])
        with but1:
...
def q8():
    ...
    with col2:
        ...
        qs3 = st.radio('What should you do if you get a cut?',['Ignore it','Wash it and put a bandage on it','Show it to your friends','Lick it'])
        but1,but2,space = st.columns([1,1,1.5])
        with but1:
...
def q9():
    ...
    with col2:
        ...
        qs3 = st.radio('Why is it important to eat breakfast?',['Its the best meal of the day','It gives you energy for school','pancakes are your favourite','Its not, you can skip it'])
        but1,but2,space = st.columns([1,1,1.5])
        with but1:
...
def q10():
    ...
    with col2:
        ...
        qs3 = st.radio('How can you keep your bones strong?',['Drink milk','Eat dairy','Take lots of vitamin D','All of the above'])
        but1,but2,space = st.columns([1,1,1.5])
        with but1:
...
def q11():
    ...
    with col2:
        ...
        qs3 = st.radio('What is the purpose of first aid?',['To help with homework','To give immediate care in emergencies','To prepare healthy food','To provide people medicine'])
        but1,but2,space = st.columns([1,1,1.5])
        with but1:
...
def q12():
    ...
    with col2:
        ...
        qs3 = st.radio('What helps soothe a sore throat?',['Eating ice cream','Drinking warm fluids','Eating spicy food','Talking a lot'])
        but1,but2,space = st.columns([1,1,1.5])
        with but1:
...
def q13():
    ...
    with col2:
        ...
        qs3 = st.radio('What is a common cold symptom?',['Runny nose','Aching muscles','Nosebleeds','Trouble moving'])
        but1,but2,space = st.columns([1,1,1.5])
        with but1:
...
def q14():
    ...
    with col2:
        ...
        qs3 = st.radio('Why should you cover your mouth when you cough/sneeze?',['To be funny','To make the sound quieter','To get your hands dirty','To prevent spraying germs'])
        but1,but2,space = st.columns([1,1,1.5])
        with but1:
...
def q15():
    ...
    with col2:
        ...
        qs3 = st.radio('What is a safe way to exercise?',['Playing sports','Jumping on the bed','Sitting and reading','None of the above'])
        but1,but2,space = st.columns([1,1,1.5])
        with but1:
...
def q16():
    ...
    with col2:
        ...
        qs3 = st.radio('What does a dentist check',['Your eyes','Your blood','Your teeth','Your muscles'])
        but1,but2,space = st.columns([1,1,1.5])
        with but1:
...
def q17():
    ...
    with col2:
        ...
        qs3 = st.radio('What should you do if you feel dizzy?',['Start running','Sit down and tell an adult','Bang your head on the wall','Eat more'])
        but1,but2,space = st.columns([1,1,1.5])
        with but1:
...
def q18():
    ...
    with col2:
        ...
        qs3 = st.radio('What is the main job of your lungs?',['To pump blood','To digest food','To help you breathe','To carry our respiration'])
        but1,but2,space = st.columns([1,1,1.5])
        with but1:
...
def q19():
    ...
    with col2:
        ...
        qs3 = st.radio('What can help you stay healthy during cold and flu season?',['Washing hands frequently','Sleeping less','Playing outside everyday','Seeing your friends more often'])
        but1,but2,space = st.columns([1,1,1.5])
        with but1:
...
def q20():
    ...
    with col2:
        ...
        qs3 = st.radio('What does it mean if someone has a headache?',['They are sleepy','They need rest and/or water','They want to play','They need to wear a hat'])
        but1,but2,space = st.columns([1,1,1.5])
        with but1:
