...
try:
    videocsv=pd.read_csv('videosratings.csv')
except:
...
if menu == 'Videos':
    ...
    if vidcat == 'All' or vidcat== 'Baking':
        ...
        with c1:
            ...
            if st.button('Play Video',key="1"):
                ...
                if "Oreo cupcakes recipe" in videocsv['Videos'].values:
                    videocsv.loc[videocsv['Videos']=='Oreo cupcakes recipe','Plays'] +=1
                else:
                    st.write("no")
    ...
    if vidcat == 'All' or vidcat == 'Music':
        ...
        with c1:
            ...
            st.write("Dead to me")
            if st.button('Play vide',key="5"):
                webbrowser.open("https://www.youtube.com/watch?v=OcUDK4kAUIw&pp=ygUKZGVhZCB0byBtZQ%3D%3D")
